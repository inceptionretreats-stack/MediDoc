...
│  ├─ GOVERNANCE.md               ← full engineering rulebook (mirrors PDF Ch.18)
│  ├─ AGENT-ROSTER.md             ← the 8 build agents + hand-off map
│  ├─ WORKFLOW.md                 ← delivery pipeline + traceability
│  ├─ HANDOVER.md                 ← live hand-off between Claude Code ↔ Codex
│  ├─ DECISION_LOG.md             ← dated log of every decision (never delete)
│  ├─ CHANGELOG.md                ← versioned change history
│  ├─ dev-log.md · tasks.md       ← progress: built/changed/fixed · todo
│  ├─ USER_FLOWS.md · API.md      ← user journeys · endpoint contracts

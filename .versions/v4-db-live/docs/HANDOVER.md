...
- **Version:** v3 frozen to `.versions/v3/`; multi-agent UI completion is deployed to Vercel.
- **Stage:** production Vercel UI deployed; Supabase DB deploy is still blocked by project
  selection/free-project limit.
- **Detailed context:** see `docs/SESSION_CONTEXT.md`.
